...
{
    private List<NotificationsResponseBody> list;
    private Context context;
    private   static String following;


    public NotificationsAdapter(List<NotificationsResponseBody> list, Context context) {
        this.list = list;
    ...
    public viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        NotificationsAdapter.viewholder viewholder=new NotificationsAdapter.viewholder(LayoutInflater.from(parent.getContext())
    ...
    public void onBindViewHolder(@NonNull viewholder holder, final int position)
    {
        ...
        if(!img.isEmpty())
        Picasso.get().load(img).placeholder(R.mipmap.profile_default_img).into(holder.circleImageView);
    ...
    public  class viewholder extends RecyclerView.ViewHolder
    {
        ...
        public viewholder(View itemView) {
            ...
            circleImageView=itemView.findViewById(R.id.notifications_img);
